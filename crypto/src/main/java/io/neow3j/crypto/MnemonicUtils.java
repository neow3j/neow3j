...
public class MnemonicUtils {
    ...
    /**
     * <p>The mnemonic must encode entropy in a multiple of 32 bits. With more entropy security is
     * improved but the sentence length increases. We refer to the initial entropy length as ENT.
     * The allowed size of ENT is 128-256 bits.</p>
     ...
     * we convert these numbers into words and use the joined words as a mnemonic sentence.</p>
     *
