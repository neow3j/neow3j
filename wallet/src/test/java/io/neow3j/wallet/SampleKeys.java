...
public class SampleKeys {
    ...
    public static final Credentials CREDENTIALS_1 = Credentials.create(KEY_PAIR_1);
    ...
    public static final Credentials CREDENTIALS_2 = Credentials.create(KEY_PAIR_2);
