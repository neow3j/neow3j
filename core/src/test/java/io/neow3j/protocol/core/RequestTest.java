...
public class RequestTest extends RequestTester {
    ...
    public void testGetBlock_Hash() throws Exception {
        neow3j.getBlock("0x2240b34669038f82ac492150d391dfc3d7fe5e3c1d34e5b547d50e99c09b468d",
                true).send();

        verifyResult(
                "{\"jsonrpc\":\"2.0\"," +
                "\"method\":\"getblock\"," +
                "\"params\":[\"0x2240b34669038f82ac492150d391dfc3d7fe5e3c1d34e5b547d50e99c09b468d\",1]," +
                "\"id\":1}");
    }
    ...
    public void testGetRawBlock_Hash() throws Exception {
        ...
        verifyResult(
                "{\"jsonrpc\":\"2.0\"," +
                "\"method\":\"getblock\"," +
                "\"params\":[\"0x2240b34669038f82ac492150d391dfc3d7fe5e3c1d34e5b547d50e99c09b468d\",0]," +
                "\"id\":1}");
    }
    ...
    public void testGetTransaction() throws Exception {
        ...
        verifyResult(
                ...
                "\"params\":[\"0x1f31821787b0a53df0ff7d6e0e7ecba3ac19dd517d6d2ea5aaf00432c20831d6\",1]," +
                "\"id\":1}");
    }

    @Test
    public void testGetRawTransaction() throws Exception {
        neow3j.getRawTransaction(
                "0x1f31821787b0a53df0ff7d6e0e7ecba3ac19dd517d6d2ea5aaf00432c20831d6").send();

        verifyResult(
                "{\"jsonrpc\":\"2.0\"," +
                "\"method\":\"getrawtransaction\"," +
                "\"params\":[\"0x1f31821787b0a53df0ff7d6e0e7ecba3ac19dd517d6d2ea5aaf00432c20831d6\",0]," +
                "\"id\":1}");
    }
    ...
    public void testGetTransactionHeight() throws Exception {
        neow3j.getTransactionHeight(
                "0x793f560ae7058a50c672890e69c9292391dd159ce963a33462059d03b9573d6a").send();

        verifyResult(
                "{\"jsonrpc\":\"2.0\"," +
                "\"method\":\"gettransactionheight\"," +
                "\"params\":[\"0x793f560ae7058a50c672890e69c9292391dd159ce963a33462059d03b9573d6a\"]," +
                "\"id\":1}");
    }
    ...
    public void testInvokeScript() throws Exception {
        neow3j.invokeScript(
                "10c00c08646563696d616c730c1425059ecb4878d3a875f91c51ceded330d4575fde41627d5b52").send();
    ...
    public void testSendMany() throws Exception {
        neow3j.sendMany(
                asList(
                        new TransactionSendAsset("0xde5f57d430d3dece511cf975a8d37848cb9e0525",
                                "100", "AcozGpiGDpp9Vt9RMyokWNyu7hh341T2bb"),
                        new TransactionSendAsset("0xde5f57d430d3dece511cf975a8d37848cb9e0525",
                                "10", "AHE5cLhX5NjGB5R2PcdUvGudUoGUBDeHX4")
                )
        ).send();
    ...
    public void testSendManyWithFrom() throws Exception {
        neow3j.sendMany(
                ...
                asList(
                        new TransactionSendAsset("0xde5f57d430d3dece511cf975a8d37848cb9e0525",
                                "100", "AbRTHXb9zqdqn5sVh4EYpQHGZ536FgwCx2"),
                        new TransactionSendAsset("0xde5f57d430d3dece511cf975a8d37848cb9e0525",
                                "10", "AK2nJJpJr6o664CWJKi1QRXjqeic2zRp8y")
                )
        ).send();
    ...
    public void testSendToAddress_TransactionSendAsset() throws Exception {
        neow3j.sendToAddress(
                new TransactionSendAsset("0xde5f57d430d3dece511cf975a8d37848cb9e0525", "10.0",
                        "AcozGpiGDpp9Vt9RMyokWNyu7hh341T2bb")
        ).send();
    ...
    public void testGetApplicationLog() throws Exception {
        neow3j.getApplicationLog(
                "420d1eb458c707d698c6d2ba0f91327918ddb3b7bae2944df070f3f4e579078b").send();
