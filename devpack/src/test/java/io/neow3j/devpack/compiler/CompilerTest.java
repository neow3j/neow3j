...
public class CompilerTest {
    ...
    public void compileHelloWorldContract() throws IOException {
        byte[] neoCode = new Compiler().compileClass(
    ...
    public void compileExampleContract() throws IOException {
        byte[] neoCode = new Compiler().compileClass("io.neow3j.devpack.template.ExampleContract");
        System.out.println(ScriptReader.convertToOpCodeString(neoCode));
        NefFile nef = new NefFile("neow3j", new Version(3, 0, 0, 0), neoCode);
        ...
        try (FileOutputStream fos =
                new FileOutputStream("/Users/claude/Desktop/tmp/neow3j-contract.nef")) {
