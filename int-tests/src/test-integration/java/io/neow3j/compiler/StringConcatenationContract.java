...
// Dummy Java file for StringConcatenationIntegrationTest. This is required to mock an existing .java file for the
// AsmHelper class. However, for the tests the precompiled .class files are used. To emphasize this, the methods in
