...
import static com.axlabs.neow3j.constants.OpCode.CHECKMULTISIG;
import static com.axlabs.neow3j.constants.OpCode.CHECKSIG;
...
public class RawVerificationScript extends NeoSerializable {
    ...
    public void serialize(BinaryWriter writer) throws IOException {
        ...
        if (publicKeys.size() > 1) {
            ...
            writer.writeByte(CHECKMULTISIG.getValue());
        } else {
            writer.writeByte(CHECKSIG.getValue());
        }
    }
