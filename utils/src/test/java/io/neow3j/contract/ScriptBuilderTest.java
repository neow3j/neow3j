...
public class ScriptBuilderTest extends TestBinaryUtils {
    ...
    public void buildVerificationScriptFromMultiplePublicKeys() {
        ...
        List<byte[]> keys = Arrays.asList(Numeric.hexStringToByteArray(key1), Numeric.hexStringToByteArray(key2));
    ...
    public void buildVerificationScriptFromSinglePublicKey() {
        ...
        byte[] script = ScriptBuilder.buildVerificationScript(Numeric.hexStringToByteArray(key));
