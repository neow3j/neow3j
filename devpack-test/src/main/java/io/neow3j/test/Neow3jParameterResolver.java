...
public class Neow3jParameterResolver implements ParameterResolver {
    ...
    public boolean supportsParameter(ParameterContext parameterContext,
        ...
        return parameterContext.getParameter().getType().equals(Neow3j.class)
                || parameterContext.getParameter().getType().equals(Neow3j.class);
    }

    @Override
    public Neow3j resolveParameter(ParameterContext parameterContext,
            ExtensionContext context) throws ParameterResolutionException {

        return (Neow3j) context.getStore(ExtensionContext.Namespace.GLOBAL)
