...
public class Notification implements InteropInterface {
    ...
    /**
     * Compares this notification to the given object. The comparison happens by reference only.
     * Thus, if you retrieve the same notification twice, e.g., with
     * {@link io.neow3j.devpack.Runtime#getNotifications(Hash160)}, then comparing the two will
     * return false.
     *
