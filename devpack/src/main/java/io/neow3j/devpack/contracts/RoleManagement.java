...
/**
 * Represents the native contract that deals with the assignment of nodes to certain roles. A node can have the roles
 * defined in {@link Role}, e.g. be an oracle node or a validator node. This contract provides the functionality to
 * check the nodes assigned a particular role.
 */
