 ...
 * <p>
 * For example, {@link OpCode#PUSHDATA1} has a prefix size of 1 which means that before the operand
 * there is one byte prefix that determines how long the operand is.
 * Or {@link OpCode#JMP} has an operand size of 1 byte which tells the offset to jump.
 */
